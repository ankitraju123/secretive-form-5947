                    ...
                    <Box className="d-content">
                      <Box className="row">
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Contouring</Link>
                          </Text>
                          <Text>
                            <Link to="#">BB & CC Cream</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Palette</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3>Eyes</h3>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        ...
                        <Box className="column">
                          ...
                          <br />
                          <Text>
                            <Link to="#">Twenty Dresses By</Link>
                          </Text>
                          <Text>
                            <Link to="#">Gajra Gang</Link>
                          </Text>
                          <Text>
                            <Link to="#">Nykaa Feshion</Link>
                          </Text>
                          <Text>
                            <Link to="#">RSVP By Nykaa Fashion</Link>
                          </Text>
                          <Text>
                            <Link to="#">Nykaa By Nykaa</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <Text>
                            <Link to="#">Pipa Bella</Link>
                          </Text>
                          <Text>
                            <Link to="#">IYKYK By Nykaa Fashion</Link>
                          </Text>
                          <Text>
                            <Link to="#">Kica</Link>
                          </Text>
                          <Text>
                            <Link to="#">Twig And Twine</Link>
                          </Text>
                          <Text>
                            <Link to="#">Likha By Nykaa Fashion</Link>
                          </Text>
                          <Text>
                            <Link to="#">Gloot</Link>
                          </Text>
                          ...
                          <Text>
                            <Link to="#">Azai By Nykaa Fashion</Link>
                          </Text>
                          <br />
                          <h3>Top Brands</h3>
                          <Text>
                          ...
                          <Text>
                            <Link to="#">Vero Moda</Link>
                          </Text>
                          <Text>
                            <Link to="#">Fabindia</Link>
                          </Text>
                          <Text>
                            <Link to="#">Na-Kd</Link>
                          </Text>
                          ...
                          <Text>
                            <Link to="#">Label Shaurya Sanadhya</Link>
                          </Text>
                          <Text>
                            <Link to="#">Biba</Link>
                          </Text>
                          ...
                          <Text>
                            <Link to="#">I Saw It First</Link>
                          </Text>
                          <Text>
                            <Link to="#">Swatantra</Link>
                          </Text>
                          <Text>
                            <Link to="#">Forever New</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <Image
                  ...
                  <MenuGroup p={2}>
                    ...
                    <MenuItem>
                      <Button w={"100%"} fontSize={13}>
                        <Link to="/login">Sign in with Mobile/Email</Link>
                      </Button>
                    </MenuItem>
                    <MenuItem>
                      <Button
                    ...
                    <Box className="d-content">
                      <Box className="row">
                        <Box className="column">
                          ...
                          &nbsp;
                          <Text>
                            <Link to="#">Face Moisturizer & Day</Link>
                          </Text>
                          <Text>
                            <Link to="#">Cream</Link>
                          </Text>
                          ...
                          <Text>
                            <Link to="#">Serums & Essence</Link>
                          </Text>
                          <Text>
                            <Link to="#">All Purpose Gels/Creams</Link>
                          </Text>
                          <br />
                          ...
                          <Text>
                            <Link to="#">Scrubs & Exfoilators</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          ...
                          <br />
                          <Text>
                            <Link to="#">Toners Under 1000</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Wash For Oily Skin</Link>
                          </Text>
                          <Text>
                            <Link to="#">Oil Free Face</Link>
                          </Text>
                          <Text>
                            <Link to="#">Moisturizer</Link>
                          </Text>
                          <Text>
                            <Link to="#">Lip Balm Under 500</Link>
                          </Text>
                          <Text>
                            <Link to="#">Vitamin C Serum</Link>
                          </Text>
                          <br />
                          ...
                          <Text>
                            <Link to="#">Sleeping Masks</Link>
                          </Text>
                          <Text>
                            <Link to="#">Masks & Peels</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Packs</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Bleach</Link>
                          </Text>
                          <br />
                          <h3 style={{ fontWeight: 500 }}>Toners</h3>
                          <br />
                          <Text>
                            <Link to="#">Toners & Mists</Link>
                          </Text>
                          <Text>
                            <Link to="#">Rose Water</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          ...
                          <br />
                          <Text>
                            <Link to="#">Lotions & Creams</Link>
                          </Text>
                          <Text>
                            <Link to="#">Body Butter</Link>
                          </Text>
                          <Text>
                            <Link to="#">Massage Oils</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shower Gels & Body</Link>
                          </Text>
                          <Text>
                            <Link to="#">Bath Salts</Link>
                          </Text>
                          <Text>
                            <Link to="#">Wash</Link>
                          </Text>
                          ...
                          <Text>
                            <Link to="#">Foot Creams</Link>
                          </Text>
                          <Text>
                            <Link to="#">Hand & Foot Masks</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>
                          ...
                          <br />
                          <Text>
                            <Link to="#">Acne Spot Correctors</Link>
                          </Text>
                          <Text>
                            <Link to="#">Nose Strips</Link>
                          </Text>
                          <Text>
                          ...
                          <Text>
                            <Link to="#">Lip Scrubs</Link>
                          </Text>
                          <Text>
                            <Link to="#">Lip Masks</Link>
                          </Text>
                          <br />
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Hair Creams & Masks</Link>
                          </Text>
                          <Text>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Hair Brusher</Link>
                          </Text>
                          <Text>
                            <Link to="#">Hair Combs</Link>
                          </Text>
                          <Text>
                            <Link to="#">Dryers & Stylers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Straighteners</Link>
                          </Text>
                          <Text>
                            <Link to="#">Rollers & Curles</Link>
                          </Text>
                          <Text>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Dry & Frizzy Hair</Link>
                          </Text>
                          <Text>
                            <Link to="#">Split Ends</Link>
                          </Text>
                          <Text>
                          ...
                          <Box className="column">
                            ...
                            <br />
                            <Text>
                              <Link to="#">Hair Growth Oil</Link>
                            </Text>
                            <Text>
                              <Link to="#">Dandruff Shampoo</Link>
                            </Text>
                            <Text>
                              <Link to="#">Castor Oil For Hair</Link>
                            </Text>
                            <Text>
                              <Link to="#">Sulphate Free Shampoo</Link>
                            </Text>
                            <Text>
                              <Link to="#">Hair Strightener</Link>
                            </Text>
                          </Box>
                        </Box>
                      </Box>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Hair Dryers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Striaghteners</Link>
                          </Text>
                          <Text>
                            <Link to="#">Curling Iron/Stylers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Multi Stylers</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>
                          ...
                          <Text>
                            <Link to="#">Epilators</Link>
                          </Text>
                          <Text>
                            <Link to="#">Body Groomers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Bikini Trimmers</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Shaving Tools</h3>
                          <Text>
                            <Link to="#">Face Epliator</Link>
                          </Text>
                          <Text>
                            <Link to="#">Dermarollers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Cleansing Brushes</Link>
                          </Text>
                          <Text>
                            <Link to="#">Acne Removal</Link>
                          </Text>
                          <br />
                          <h3 style={{ fontWeight: 500 }}>Oral Care</h3>
                          <Text>
                            <Link to="#">Electric Toothbrushes</Link>
                          </Text>
                          <Text>
                            <Link to="#">Electric Flossers</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Top Brands</h3>
                          ...
                          <Text>
                            <Link to="#">Ikonic Professinal</Link>
                          </Text>
                          <Text>
                            <Link to="#">Nova</Link>
                          </Text>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Herbal Hair Care</Link>
                          </Text>
                          <Text>
                            <Link to="#">Routine Finder</Link>
                          </Text>
                        </Box>
                      </Box>
                    </Box>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Body Scrubs & Exfoliants</Link>
                          </Text>
                          <Text>
                            <Link to="#">Soaps</Link>
                          </Text>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Sanitry Napkins</Link>
                          </Text>
                          <Text>
                            <Link to="#">Menstrual Cups</Link>
                          </Text>
                          <Text>
                            <Link to="#">Tampons</Link>
                          </Text>
                          <Text>
                            <Link to="#">Pantyliners</Link>
                          </Text>
                          <Text>
                            <Link to="#">Period Panties</Link>
                          </Text>
                          <Text>
                            <Link to="#">Intimate Wash</Link>
                          </Text>
                          <Text>
                            <Link to="#">Other Period Essentials </Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Mens Grooming</h3>
                          <Text>
                            <Link to="#">Razors & Catridges</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shaving Cream, Doams &</Link>
                          </Text>
                          <Text>
                            <Link to="#">Gels</Link>
                          </Text>
                          <Text>
                            <Link to="#">Pre & Post Shaves</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shaving & Trimmers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shaving Brush</Link>
                          </Text>
                          <Text>
                            <Link to="#">Beard & Moustache Care</Link>
                          </Text>
                          <Text>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Face Mask</Link>
                          </Text>
                          <Text>
                            <Link to="#">Hand Sanitizer</Link>
                          </Text>
                          <Text>
                            <Link to="#">Gloves, PPE & Face</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shields</Link>
                          </Text>
                        </Box>
                      </Box>
                    </Box>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Face Cream</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Mist</Link>
                          </Text>
                          <Text>
                            <Link to="#">Facial Kits</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Skin</h3>
                          ...
                          <Text>
                            <Link to="#">Scrubs & Exafoliators</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Tools</Link>
                          </Text>
                          <Text>
                            <Link to="#">Face Gel</Link>
                          </Text>
                          <Text>
                            <Link to="#">Lip Scurb</Link>
                          </Text>
                        </Box>{" "}
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Hair</h3>
                          <Text>
                            <Link to="#">Shampoo & Cleanser</Link>
                          </Text>
                          <Text>
                        ...
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Shop By Concern</h3>
                          <Text>
                            <Link to="#">Tan Removal</Link>
                          </Text>
                          <Text>
                            <Link to="#">Pigmentation</Link>
                          </Text>
                          <Text>
                            <Link to="#">Acne Treatement</Link>
                          </Text>
                          <Text>
                            <Link to="#">Skin Lightening</Link>
                          </Text>
                          <Text>
                            <Link to="#">Anti Aging</Link>
                          </Text>
                          <Text>
                            <Link to="#">Dark Circles</Link>
                          </Text>
                        </Box>
                      </Box>
                    </Box>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Nutritional upplements</Link>
                          </Text>
                          <Text>
                            <Link to="#">Body Wash & Soaps</Link>
                          </Text>
                          <Text>
                            <Link to="#">Lotions & Creams</Link>
                          </Text>
                        ...
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Breast Firming Gels &</Link>
                          </Text>
                          <Text>
                            <Link to="#">Creams</Link>
                          </Text>
                          <Text>
                            <Link to="#">Nipple Creams</Link>
                          </Text>
                          <Text>
                            <Link to="#">Nutritional Supplements</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Nursing & Feeding</h3>
                          <Text>
                            <Link to="#">Feeding Bottle & Nipples</Link>
                          </Text>
                          <Text>
                            <Link to="#">Teethers & Soothers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Breast Pumps</Link>
                          </Text>
                          <Text>
                            <Link to="#">Breast Pads</Link>
                          </Text>
                          <Text>
                            <Link to="#">Cleaning & Feeding</Link>
                          </Text>
                          <Text>
                            <Link to="#">Bibs</Link>
                          </Text>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Calcium & Vitamin D</Link>
                          </Text>
                          <Text>
                            <Link to="#">Magnesium & Zinc</Link>
                          </Text>
                          <Text>
                            <Link to="#">Omega & Fish Oil</Link>
                          </Text>
                          <Text>
                            <Link to="#">Vitamin C</Link>
                          </Text>
                          <Text>
                            <Link to="#">Other Supplements</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Plant Protein</Link>
                          </Text>
                          <Text>
                            <Link to="#">BCAA & Other Muscle</Link>
                          </Text>
                          <Text>
                            <Link to="#">Support</Link>
                          </Text>
                          <Text>
                            <Link to="#">Protein & Energy Bars</Link>
                          </Text>
                          <Text>
                            <Link to="#">Protein Snacks</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Edible Seeds</Link>
                          </Text>
                          <Text>
                            <Link to="#">Oils & Ghee</Link>
                          </Text>
                          <Text>
                            <Link to="#">Herbal Tea</Link>
                          </Text>
                          <Text>
                            <Link to="#">Heakth Drinks</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Pain Relief</h3>
                          <Text>
                            <Link to="#">Muscle & Joints</Link>
                          </Text>
                          <Text>
                            <Link to="#">Ortho Oils</Link>
                          </Text>
                          <Text>
                            <Link to="#">Perios Cramps</Link>
                          </Text>
                          <Text>
                            <Link to="#">Period Cramps</Link>
                          </Text>
                          <Text>
                            <Link to="#">Cough & Cold</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Razors & Cartridges</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shavers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Trimmers</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shaving Creams</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shaving Foams</Link>
                          </Text>
                          <Text>
                            <Link to="#">Shaving Gels</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Beard Butter</Link>
                          </Text>
                          <Text>
                            <Link to="#">Beard Softener</Link>
                          </Text>
                          <Text>
                            <Link to="#">Beard Wax</Link>
                          </Text>
                          <Text>
                            <Link to="#">Bread Wash</Link>
                          </Text>
                          <Text>
                            <Link to="#">Moustache Oil</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Hair Care</h3>
                          ...
                          <Text>
                            <Link to="#">Professional Products</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Bath & Body</h3>
                          <Text>
                            <Link to="#">Bath/Shower Gels</Link>
                          </Text>
                          <Text>
                            <Link to="#">Soaps</Link>
                          </Text>
                        ...
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Shop By Concern</h3>
                          <Text>
                            <Link to="#">Anti Dandruff</Link>
                          </Text>
                          <Text>
                            <Link to="#">Anti Damge</Link>
                          </Text>
                          <Text>
                            <Link to="#">Anti Hairfall</Link>
                          </Text>
                          <Text>
                            <Link to="#">Scalp Treatement</Link>
                          </Text>
                          <Text>
                            <Link to="#">Anti Acne</Link>
                          </Text>
                          <Text>
                            <Link to="#">Anti Ageing</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Top Brands</h3>
                          ...
                          <Text>
                            <Link to="#">Gets-By</Link>
                          </Text>
                          <Text>
                            <Link to="#">Gilette</Link>
                          </Text>
                          <Text>
                            <Link to="#">Livon</Link>
                          </Text>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Perfumes (EDT / EDP )</Link>
                          </Text>
                          <Text>
                            <Link to="#">Body Mists / Sprays</Link>
                          </Text>
                          <Text>
                            <Link to="#">Deodorants / Roll-Ons</Link>
                          </Text>
                        </Box>
                        <Box className="column">
                          <h3 style={{ fontWeight: 500 }}>Gifts & Combos</h3>
                          <Text>
                            <Link to="#">Earthy & Woody</Link>
                          </Text>
                          <Text>
                            <Link to="#">Floral</Link>
                          </Text>
                          <Text>
                            <Link to="#">Spicy & Warm</Link>
                          </Text>
                          <Text>
                            <Link to="#">Fresh & Aquatic</Link>
                          </Text>
                          <Text>
                            <Link to="#">Oud Collection</Link>
                          </Text>
                          <Text>
                            <Link to="#">Fruity</Link>
                          </Text>
                    ...
                    <Box className="d-content">
                      <Box className="row" style={{ display: "flex" }}>
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">T-Shirt Bra</Link>
                          </Text>
                          <Text>
                            <Link to="#">Padded Bra</Link>
                          </Text>
                          <Text>
                            <Link to="#">Non-Padded Bra</Link>
                          </Text>
                          <Text>
                            <Link to="#">Wireless Bra</Link>
                          </Text>
                          <Text>
                            <Link to="#">Underwired Bra</Link>
                          </Text>
                          <Text>
                            <Link to="#">Strapless Bra</Link>
                          </Text>
                        </Box>{" "}
                        <Box className="column">
                          ...
                          <Text>
                            <Link to="#">Nightdress</Link>
                          </Text>
                          <Text>
                            <Link to="#">Babydolls</Link>
                          </Text>
                          <Text>
                            <Link to="#">Pajamsa</Link>
                          </Text>
                          <Text>
                            <Link to="#">Wraps</Link>
                          </Text>
